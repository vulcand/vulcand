...
.. code-block:: bash
  ...
  docker pull mailgun/vulcand:v0.8.0-alpha.1

  # launch vulcand in a container
  docker run -p 8182:8182 -p 8181:8181 mailgun/vulcand:v0.8.0-alpha.1 /go/bin/vulcand -apiInterface=0.0.0.0 --etcd=http://172.17.42.1:4001

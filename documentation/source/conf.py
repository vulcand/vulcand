...
project = u'Vulcand documentation'
copyright = u'What?'
...
htmlhelp_basename = 'VulcandRESTAPIdoc'
...
latex_documents = [
  ('index', 'VulcandRESTAPI.tex', u'Vulcand REST API Documentation',
   u'Vulcand Inc', 'manual'),
]
...
man_pages = [
    ('index', 'vulcandrestapi', u'Vulcand REST API Documentation',
     [u'Vulcand Inc'], 1)
]
